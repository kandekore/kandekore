  ...
  I'm a developer who started in **sales** — not a server room. Seven
  years at Yell selling digital advertising, then Cisco and Microsoft
  training before that. In 2009 I taught myself to code and never looked
  back.

  That commercial foundation shapes everything I build. I understand ROI,
  lead generation, and conversion because I spent years selling those
  outcomes to businesses. No bootcamp teaches that.

  - 🏢 Founded a **digital agency** in 2015, grew it to 6 staff
  - 🌐 Operate **[Host Dada](https://hostdada.co.uk)** —
  Nominet-accredited hosting & domain registrar, Microsoft Channel Partner
  - 🚗 Run **[Lead Stack](https://leadstack.biz)** — generating 30,000+
  qualified leads/year for the automotive salvage industry
  - 🔍 Built **[Vehicle Data
  Information](https://vehicledatainformation.co.uk)** — live consumer
  platform for vehicle valuations, MOT history & HPI-style checks
  - 🎓 **University of Birmingham** Full-Stack Bootcamp — **A+ grade**,
  Anna Lebiedziewics Outstanding Student Award
  ...
  **Marketing & Analytics**
  ...
  | 🎓 **A+ Graduate** | University of Birmingham Full-Stack Bootcamp |
  | 🏆 **Anna Lebiedziewics Outstanding Student Award** | Top of cohort |
